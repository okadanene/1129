...
<head>
    ...
    <link href="<?php echo get_template_directory_uri(); ?>/https://fonts.googleapis.com/css2?family=IBM+Plex+Sans+JP:wght@500&family=Noto+Sans+JP:wght@400;900&family=Zen+Kaku+Gothic+New:wght@700&display=swap" rel="stylesheet">
    <!-- jQueryの読み込み -->
    <script src="<?php echo get_template_directory_uri(); ?>/https://code.jquery.com/jquery-2.2.4.js" integrity="sha256-iT6Q9iMJYuQiMWNd9lDyBUStIq/8PuOW33aOqmvFpqI=" crossorigin="anonymous"></script>
    ...
    <header>
        ...
        <nav class="header-menu">
            <ul>
                ...
                <li><a href="<?php echo home_url(); ?>/#company">COMPAY</a></li>
